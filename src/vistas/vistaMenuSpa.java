...
public class vistaMenuSpa extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jbCliente.setBackground(new java.awt.Color(155, 216, 185));
        jbCliente.setForeground(new java.awt.Color(0, 0, 0));
        jbCliente.setText("Clientes");
        jbCliente.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0)));
        ...
        jpFondoMenuLayout.setHorizontalGroup(
            ...
            .addGroup(jpFondoMenuLayout.createSequentialGroup()
                ...
                .addGroup(jpFondoMenuLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                    ...
                    .addComponent(jbCliente, javax.swing.GroupLayout.PREFERRED_SIZE, 139, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        jpFondoMenuLayout.setVerticalGroup(
            jpFondoMenuLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jpFondoMenuLayout.createSequentialGroup()
    ...
    private void jbCargarSesionActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbCargarSesionActionPerformed
        vistaCargarSesion ventana= null;

        // Buscar si ya existe una instancia en el escritorio
        for (JInternalFrame frame : Escritorio.getAllFrames()) {
            if (frame instanceof vistaCargarSesion) {
                ventana = (vistaCargarSesion) frame;
                break;
            }
        }
        ...
        if (ventana == null) {
            ...
            ventana = new vistaCargarSesion(Escritorio);
            // Instanciarla
    ...
    private void jbConsultoriosActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbConsultoriosActionPerformed
        ...
        if (ventana == null) {
            // Crear nueva si no estaba abierta la ventana
            ventana = new vistaConsultorios(Escritorio);
            // Instanciarla
            Escritorio.add(ventana);
    ...
    private void jMenuItem9ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem9ActionPerformed
        ...
        int confirm = JOptionPane.showConfirmDialog(
                this, "¿Seguro que desea cargar los datos de prueba?\nEsto puede sobrescribir o mezclar datos existentes.", "Confirmar carga de datos de prueba", JOptionPane.YES_NO_OPTION, JOptionPane.WARNING_MESSAGE);
        if (confirm == JOptionPane.YES_OPTION) {
            Gp10_Spa.cargarDatosDePrueba();
            JOptionPane.showMessageDialog(this, "Datos de prueba cargados exitosamente!", "Carga completada", JOptionPane.INFORMATION_MESSAGE);
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(vistaMenuSpa.class
